...
namespace NSMB.Utils {
    public static class Layers {
        ...
        private static int? _layerGround, _layerHitsNothing, _layerDefault, _layerPassthrough, _layerLooseCoin, _layerEntity, _layerWater;
        ...
        public static int LayerWater { get => LazyLoadLayer(ref _layerWater, "Water"); }
